...
- Let us considet the observable variable $y_{t}$ as
...
-    $\epsilon_{t} \approx N(0,H_{t})$ is i.i.d with $H_{t}$ is $k\times k$ dimesional positive definite variance matrix.
- and state space equation at time $t$ be $y_{t}$ and $S_{t}$ respectively.
- We can express 
